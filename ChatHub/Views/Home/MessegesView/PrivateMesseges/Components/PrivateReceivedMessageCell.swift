//
//  PrivateReceivedMessageCell.swift
//  ChatHub
//
//  Created by Jakub Malczyk on 28/05/2023.
//

import UIKit

class PrivateReceivedMessageCell: UITableViewCell {
    ...
    private func updateContext(with model: MessageModel?) {
        ...
        messageBackroundView.backgroundColor = UIColor(named: "lightPurple")
    }
